...
printf "      \e[1;31m[\e[0m\e[1;77mv1.0\e[0m\e[1;31m]\e[0m\e[1;77m recoded Wharkly (Tunnelt1) (thanks to linuxchoice )\e[0m\n"
}
...
printf "\n"
data='{"phone_id":"'$phone'", "_csrftoken":"'$var2'", "username":"'$user'", "guid":"'$guid'", "device_id":"'$device'", "password":"'$pass'", "login_attempt_count":"1000"}'
...
cp $user_account.following.temp $user_account.following.1000
count=.1OOO
...
cp $user_account.followers.temp $user_account.followers.1OOO
count=1000
